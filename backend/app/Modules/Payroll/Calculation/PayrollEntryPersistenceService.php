...
/**
 * Persists a calculated (or failed) entry with transactional REPLACEMENT of its
 * generated lines — never incremental appends. A finalized entry is never touched
 * (finalization is a later phase). On failure, any prior financial result and lines
 * are cleared so a stale success can never survive a later failure.
 */
