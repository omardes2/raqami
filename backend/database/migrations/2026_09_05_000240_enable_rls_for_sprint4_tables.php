...
/**
 * Extend PostgreSQL Row-Level Security (ADR-002) to the new Sprint 4
 * tenant-owned attendance tables. Same two-policy pattern as Sprint 0/1/2/3:
 * strict tenant match for all commands + read-only visibility for the audited
 * platform portal. Closed by default when no tenant context is set.
 */
